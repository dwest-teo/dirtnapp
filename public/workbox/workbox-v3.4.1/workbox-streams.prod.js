(this.workbox = this.workbox || {}),
  (this.workbox.streams = (function() {
        ...
        stream: new ReadableStream({
          pull(e) {
            return n[s]
              ...
              .then(t => {
                if (t.done)
                  return ++s >= n.length ? (e.close(), void r()) : this.pull(e);
                e.enqueue(t.value);
              })
              .catch(e => {
                throw (o(e), e);
    ...
    function t(t, r) {
      const { done: o, stream: s } = e(t),
        c = n(r);
      return { done: o, response: new Response(s, { headers: c }) };
    }
    let r = void 0;
    function o() {
      if (void 0 === r)
        try {
          new ReadableStream({ start() {} }), (r = !0);
        } catch (e) {
          r = !1;
        }
      return r;
      ...
      strategy: function(e, r) {
        return (
          (s = babelHelpers.asyncToGenerator(function*({
            ...
            if (o()) {
              const { done: n, response: o } = t(
                e.map(function(e) {
                  return e({ event: s, url: c, params: a });
                }),
                r
              );
              return s.waitUntil(n), o;
            }
            const u = yield Promise.all(
              e
                ...
                .map(
                  ((i = babelHelpers.asyncToGenerator(function*(e) {
                    const n = yield e;
            ...
            var i;
            const l = n(r);
            return new Response(new Blob(u), { headers: l });
          })),
          function(e) {
