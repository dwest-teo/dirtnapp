(this.workbox = this.workbox || {}),
  (this.workbox.precaching = (function(e, t, n, r, s) {
    ...
    const u = ((d = babelHelpers.asyncToGenerator(function*(e) {
      ...
      return new Response(
        n,
        ['headers', 'status', 'statusText'].map(function(e) {
          return t[e];
        })
      );
    })),
    ...
    class h {
      constructor(e) {
        (this.f = t.cacheNames.getPrecacheName(e)),
          (this.y = new Map()),
          (this.p = new a(this.f));
      }
      addToCacheList(e) {
      ...
      install(e = {}) {
        ...
        return babelHelpers.asyncToGenerator(function*() {
          ...
          const s = [],
            i = [];
          for (const e of t.y.values())
            (yield t.p.l(t.f, e)) ? i.push(e) : s.push(e);
          return (
            yield Promise.all(
              s.map(function(n) {
                return t.R(n, e.plugins);
              })
            ),
            { updatedEntries: s, notUpdatedEntries: i }
          );
        })();
      }
      activate(e = {}) {
        ...
        return babelHelpers.asyncToGenerator(function*() {
          ...
          for (const i of r) {
            ...
            yield s.cacheWrapper.put(t.f, i, r, e.plugins), yield n.delete(i);
          }
          return t.m();
        })();
      }
      ...
      R(e, t) {
        var n = this;
        return babelHelpers.asyncToGenerator(function*() {
          let i = yield r.fetchWrapper.fetch(e.s, null, t);
          return (
            i.redirected && (i = yield u(i)),
            yield s.cacheWrapper.put(n.g(), e.r, i, t),
            yield n.p.d(e),
            !0
          );
        })();
      ...
      _(e) {
        var t = this;
        return babelHelpers.asyncToGenerator(function*() {
          if (!(yield caches.has(t.f))) return [];
          const n = yield caches.open(t.f),
      ...
      U(e) {
        var t = this;
        return babelHelpers.asyncToGenerator(function*() {
          const n = (yield t.p.u()).filter(function(t) {
      ...
      getCachedUrls() {
        return Array.from(this.y.keys()).map(e => new URL(e, location).href);
      }
    }
    var f = Object.freeze({ PrecacheController: h });
    let y = !1,
      p = !1,
      b = !1,
      w = [];
          ...
          R.addToCacheList(e),
            y ||
              ...
              self.addEventListener('install', e => {
                e.waitUntil(R.install({ suppressWarnings: b, plugins: w }));
              }),
              self.addEventListener('activate', e => {
                e.waitUntil(R.activate({ plugins: w }));
              }));
        },
        addRoute: e => {
          p ||
